...
func NewExtractionService(root string, extractor *Service, repo documents.Repository) (*ExtractionService, error) {
	if extractor == nil {
	...
	return &ExtractionService{root: abs, extractor: extractor, repo: repo}, nil
}
...
// concurrent or crashed run never leaves truncated JSON behind.
